...
export class SubOrderOrderInfoDto {
...
export class SubOrderSellerResponseDto {
  ...
  @ApiProperty({ description: '주문 정보', type: SubOrderOrderInfoDto })
  order: SubOrderOrderInfoDto;
